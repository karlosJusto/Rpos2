...
import HoraModificada from './HoraModificada'

const SidebarGenerica = () => {
  const [open, setOpen] = useState(false)
  return (
    <div className='bg-white py-2 fixed top-0 left-0 right-0 shadow-md flex justify-between px-2 '>
      ...
      <h1><span className='text-gray-800 font-extrabold'>Freidora |</span> En elaboración: <span className='text-gray-500 font-extrabold text-lg'><HoraModificada/></span> </h1>
      
      <h1 className='text-gray-500 font-extrabold p-[0.5vh]'><Reloj/></h1>
      ...
      <div className={`${open ? "w-32" : "w-0"} bg-[#f2ac02] rounded-r-2xl min-h-screen fixed top-0 left-0 transition-all duration-300`}>
        <div className={`${!open && "hidden"} pt-3`}>
         ...
         <ul className=" flex  w-[6vw] flex-col justify-between text-center items-center gap-8   bg-[#f2ac02] rounded-3xl">
          ...
          <svg width="42px" height="42px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="1.2">
          ...
          <Link className='p-3 mb-2 hover:bg-gray-100 hover:rounded-2xl' to={"/onLine"}>
...
export default SidebarGenerica