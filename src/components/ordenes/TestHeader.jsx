            ...
            <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="es">
              <StaticDatePicker 
                ...
                sx={{
                  ...
                  '& .MuiDialogActions-root': { paddingTop: '8px' },
                  '& .MuiPickersDay-root': { fontSize: '1rem', width: '36px', height: '36px' },
                  '& .MuiPickersCalendarHeader-label': { fontSize: '1.1rem'},
                  '& .MuiPickersCalendarHeader-switchViewButton': { fontSize: '1.1rem' },
                }}
              />
            </LocalizationProvider>
          </ThemeProvider>
        </Modal.Body>
        <Modal.Footer className='border-t-0 flex justify-between'>
          <Button variant="outline-danger" className="shadow-sm p-2 font-nunito" onClick={handleCloseCalendarModal}>
            Cancelar
          </Button>
          <Button variant="outline-warning" className="shadow-sm p-2 font-nunito text-yellow-600 border-yellow-500 hover:text-yellow-700 hover:border-yellow-700" onClick={handleAcceptDateModal}>
            Aceptar
          </Button>
        </Modal.Footer>
      </Modal>
        ...
        <Offcanvas.Body>
          <Nav className="flex-column">
            <ul className="list-unstyled ms-2 flex flex-col justify-start text-center items-center gap-7">
              ...
              <li><Link className='p-3 hover:bg-gray-100 hover:rounded-2xl block' to={"/cocina"} onClick={toggleOffcanvasMenu}>
              ...
              <li><Link className='p-3 hover:bg-gray-100 hover:rounded-2xl block' to={"/buscadorPedidos"} onClick={toggleOffcanvasMenu}>
              ...
              <li><Link className='p-3 hover:bg-gray-100 hover:rounded-2xl block' to={"/stock"} onClick={toggleOffcanvasMenu}>
              ...
              <li><Link className='p-3 mb-2 hover:bg-gray-100 hover:rounded-2xl block' to={"/login"} onClick={toggleOffcanvasMenu}>
