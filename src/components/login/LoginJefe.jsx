    ...
    try {
      ...
      if (!docSnapshot.exists()) {
        ...
        await setDoc(docRef, {
          ...
          vd: 0,
          stock: currentStock, 
          stock_anterior: stockAnteriorParaHoy, 
          entran: 0,
          baja: 0,
          devueltos: 0,
        });
