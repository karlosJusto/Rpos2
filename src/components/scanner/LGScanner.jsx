...
const LGScanner = () => {
  ...
  return (
    <>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto pr-3 pt-1 d-flex justify-content-between w-100">
              ...
              <div className="d-flex justify-content-center flex-grow-1">
                <h1 className="text-xl font-nunito ms-28 font-extrabold text-gray-600">{texto}</h1>
              </div>
      ...
      <div>
      {/* Pasa el nombre del empleado a Scanner como prop */}
      <Scanner />
    </div>
